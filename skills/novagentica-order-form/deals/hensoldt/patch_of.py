...
DST="/home/user/workflows/skills/novagentica-order-form/deals/hensoldt/"
...
''','')
# order details
p.one('"[YYYY]-NVG-[XYZ]-SC-0[XX]"','"2026-NVG-HE-SC-001"')
...
p.one('fieldRow("Contact \\u2014 Customer", "[Name, title]")','fieldRow("Contact \\u2014 Customer", "André Scheidhammer, Chief Information Officer")')
p.one('fieldRow("Contact \\u2014 Novagentica", "[Name, title]")','fieldRow("Contact \\u2014 Novagentica", "Felix Bühner, Commercial Lead")')
...
# signature + output
p.one('c.push(sigBlock("For [Customer]"));','c.push(sigBlock("For HENSOLDT AG"));')
p.one('{ docTitle: "Novagentica Order Form \\u2014 Subscription (DRAFT)", headerLabel: "Order Form \\u00B7 Subscription \\u00B7 DRAFT" }',
      '{ docTitle: "Novagentica Order Form \\u2014 Subscription \\u2014 HENSOLDT AG", headerLabel: "Order Form \\u00B7 Subscription \\u00B7 Hensoldt" }')
p.one('"Novagentica_OF_Subscription_DRAFT.docx"','"/home/user/workflows/outputs/Novagentica_OF_Subscription_Hensoldt.docx"')
save("build_of_subscription_hensoldt.js", p.t)
...
''','')
q.one('"[YYYY]-NVG-[XYZ]-PS-0[XX]"','"2026-NVG-HE-PS-001"')
...
q.one('fieldRow("Contact \\u2014 Customer", "[Name, title]")','fieldRow("Contact \\u2014 Customer", "André Scheidhammer, Chief Information Officer")')
q.one('fieldRow("Contact \\u2014 Novagentica", "[Name, title]")','fieldRow("Contact \\u2014 Novagentica", "Felix Bühner, Commercial Lead")')
...
# delivery model: Co-build is pre-selected in the canonical script (always Co-build); nothing to tick here
# services overview
...
q.one('c.push(note("Add or remove MVP rows to match the engagement. Keep this table to outcomes and effort; detailed scope and acceptance criteria belong in the SoW / Appendix 1."));','c.push(note("Hensoldt MVP plan (27 person-days). MVP2 is conditional on works-council (Betriebsrat) approval \\u2014 see SoW. Detailed scope and acceptance criteria belong in the SoW / Appendix 1."));')
...
q.one('c.push(sigBlock("For [Customer]"));','c.push(sigBlock("For HENSOLDT AG"));')
q.one('{ docTitle: "Novagentica Order Form \\u2014 Professional Services (DRAFT)", headerLabel: "Order Form \\u00B7 Professional Services \\u00B7 DRAFT" }',
      '{ docTitle: "Novagentica Order Form \\u2014 Professional Services \\u2014 HENSOLDT AG", headerLabel: "Order Form \\u00B7 Professional Services \\u00B7 Hensoldt" }')
q.one('"Novagentica_OF_Professional_Services_DRAFT.docx"','"/home/user/workflows/outputs/Novagentica_OF_Professional_Services_Hensoldt.docx"')
save("build_of_ps_hensoldt.js", q.t)
