...
c.push(note("Hensoldt: the standard per-run over-consumption / overage clause has been removed by agreement (committed-volume model). Reinstate metered overage only if the commercial model changes."));
...
write(buildDoc(c, { docTitle: "Novagentica Order Form \u2014 Subscription \u2014 HENSOLDT AG", headerLabel: "Order Form \u00B7 Subscription \u00B7 Hensoldt" }),
  "/home/user/workflows/outputs/Novagentica_OF_Subscription_Hensoldt.docx");
