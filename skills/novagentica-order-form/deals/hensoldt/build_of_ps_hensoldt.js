...
c.push(table([900, 2900, 5226], [
  ...
  new TableRow({ children: [tc("\u2612", { w: 900, align: AT.CENTER, fill: T.CREAM2 }), tc([cellPara([{ text: "Novagentica-built", bold: true }])], { w: 2900 }), tc("Novagentica designs, builds and enforces the agents and delivers them into the Customer\u2019s runtimes.", { w: 5226 })] }),
