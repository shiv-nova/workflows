...
c.push(table([3000, 6026], [
  ...
  fieldRow("Order Form no.", "2026-NVG-EX-PS-001"),
...
c.push(note("ACME MVP plan (27 person-days). MVP2 is conditional on works-council approval \u2014 see SoW. Detailed scope and acceptance criteria belong in the SoW / Appendix 1."));
...
write(buildDoc(c, { docTitle: "Novagentica Order Form \u2014 Professional Services \u2014 ACME Defence AG", headerLabel: "Order Form \u00B7 Professional Services \u00B7 ACME" }),
  "/home/user/workflows/outputs/Novagentica_OF_Professional_Services_Example.docx");
